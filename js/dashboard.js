...
function initDashboard() {
    ...
    if (taskForm) {
        taskForm.addEventListener('submit', function(e) {
            ...
            const requesterName = document.getElementById('task-requester-name').value;
            const requesterEmail = document.getElementById('task-requester-email').value;
            const requesterPhone = document.getElementById('task-requester-phone').value;
            ...
            firebase.firestore().collection('tasks').add(taskData)
                .then(() => {
                    ...
                    alert('Sarcină creată cu succes!');
                })
                .catch(error => {
                    console.error('Error creating task:', error);
                    alert('Eroare la crearea sarcinii: ' + error.message);
                });
        });
    }
